...
int main() {
    ...
    // Define an array to store pointers to data blocks (index block)
    long indexBlock[100] = {0}; // Initialize all to 0 (empty)
    ...
    while (1) {
        ...
        printf("Data: ");
        scanf(" %[^\n]", block.data); // Read input with spaces
    ...
    while (1) {
        ...
        // Check if the block exists in the index
